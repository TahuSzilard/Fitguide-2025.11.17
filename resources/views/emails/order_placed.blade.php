    ...
    <tr>
      <td align="center" style="padding:24px 12px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
          ...
          <tr>
            <td align="center" style="padding:22px 24px 8px;">
              <div style="width:64px;height:64px;border-radius:50%;background:#2f9c4f;
                          display:inline-block;line-height:64px;font-size:30px;color:#ffffff;">
                ✓
              </div>
            </td>
          </tr>
          ...
          <!-- TITLE -->
          <tr>
            <td style="padding:4px 32px 6px;color:#ffffff;" align="center">
          ...
          <tr>
            <td style="padding:0 32px 18px;color:#c5d3f1;font-size:14px;" align="center">
              Order <strong>#{{ $order->id }}</strong> has been received.
            </td>
          </tr>
          ...
          <tr>
              <td style="padding:0 24px 18px;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                        style="background:#0e2342;border-radius:12px;padding:18px;color:#e3ecff;font-size:14px;">

                      @foreach ($order->items as $item)
                        <tr style="vertical-align:top;">

                            <!-- TERMÉK NEV + DARABSZÁM + DARABÁR -->
                            ...
                            <!-- TERMÉKSOR ÖSSZESEN -->
                            <td align="right" style="padding:10px 0;font-weight:600;white-space:nowrap;">
                      ...
                      <tr>
                          <td style="padding:12px 0;opacity:0.8;">Subtotal</td>
                      ...
                      <tr>
                          <td style="padding:6px 0;opacity:0.8;">Shipping</td>
          ...
          <!-- DELIVERY -->
          <tr>
            <td align="center" style="padding:0 24px 18px;font-size:13px;color:#c5d3f1;">
              Estimated delivery by <strong>{{ $order->delivery_date }}</strong>
            </td>
          </tr>
